<template>
  <div>
    ...
    <div v-show="sidebar === 'layer'">
      <section class="sidebar">
        <md-toolbar md-elevation="1" style="background: #f36c3f; color: #FFF;">
          <span class="md-title nav-title">
            <strong>{{ $t('map.sidebarLayer.title') }}</strong>
          </span>

          <div class="md-toolbar-section-end">
            <!-- open list of layers -->
            <div class="box-options">
              <el-tooltip effect="dark" :content="$t('map.sidebarLayer.btnAdd')" placement="bottom-end">
