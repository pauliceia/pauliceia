<template>
    <div class="box-info" v-show="boxInfoVector">
        <header class="header">
            ...
            <button class="btn btn-success btn-feature" @click="getFeature()">{{ $t('map.viewInfoVector.btnFeature') }}</button>
            <button class="btn btn-secondary btn-box" @click="getBox()">{{ $t('map.viewInfoVector.btnBox') }}</button>
