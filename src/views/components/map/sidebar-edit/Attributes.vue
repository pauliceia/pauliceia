  ...
  <section class="box-attr" v-show="attr !== null">
    ...
    <div class="form-attr">
      <div
        ...
        :key="prop != undefined ? prop.key : null"
      >
        <div v-if="prop != undefined">
          <label>{{ prop.key }}:</label>
          <input
            :type="_getAttrLayer(prop.type)"
            :name="prop.key"
            v-model="prop.value"
    ...
    async insertFeature() {
      if (this.featuresWKT != null) {
        try {
          ...
          let coordinates = this.featuresWKT
            .split("(")[1]
            .split(")")[0]
            .split(" ");
          let newFeature = {
          ...
          this.$alert(
            "Erro ao cadastrar o vetor, contate o administrador do sistema!",
            "Desculpa",
            {
        ...
        this.$alert(
          "É necessário inserir o vetor no mapa, primeiramente!",
          "Insira o vetor",
          {
            dangerouslyUseHTMLString: true,
            confirmButtonText: "OK",
