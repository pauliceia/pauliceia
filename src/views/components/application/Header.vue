    ...
    <nav class="navbar navbar-expand-md navbar-light bg-light">
      <router-link to="/home" class="navbar-brand">
        <img
          :src="logo"
          class="logo"
          title="logo of pauliceia"
          alt="logo of pauliceia"
        />
      </router-link>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto">
          <li class="nav-item">
            <router-link
              :class="
                this.$route.path == '/home' ? 'nav-link active' : 'nav-link'
              "
              to="/home"
          ...
          <li class="nav-item">
            <router-link
              :class="
                this.$route.path == '/explore' ? 'nav-link active' : 'nav-link'
              "
              to="/explore"
          ...
          <li class="nav-item">
            ...
            <a
              :class="
                this.$route.path == '/tutorial' ? 'nav-link active' : 'nav-link'
              "
              href="https://drive.google.com/drive/folders/1M7iU2iz46i2gIgfctkUCZdBARWJykcoT?usp=sharing"
              target="_blank"
              >Tutorial</a
            >
          </li>
          <li class="nav-item">
            <router-link
              :class="
                this.$route.path == '/about' ? 'nav-link active' : 'nav-link'
              "
              to="/about"
          ...
          <li class="nav-item">
            <router-link
              :class="
                this.$route.path == '/contact' ? 'nav-link active' : 'nav-link'
              "
              to="/contact"
