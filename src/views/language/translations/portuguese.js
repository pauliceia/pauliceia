...
export default {
  ...
  dashboard: {
    ...
    notification: {
      ...
      ofYourMessageGlobalNotification:
        "da sua mensagem nas suas notificações globais",
    ...
    newLayer: {
      ...
      keywordsD:
        "Palavra-chave é uma etiqueta/rótulo relacionado a camada, que indica qual tipo ela pertence, como ruas, endereços, crimes e etc.",
      collaboratorsD:
        "Colaboradores são as pessoas que poderão adicionar, editar ou remover os vetores da camada. Vetores são as geometrias da camada, como um ponto, linha ou polígono. Apenas o criador da camada pode editar este campo por segurança!",
      descriptionD: "Descrição é uma descrição/informação sobre a camada.",
      referenceD:
        "Referência é a fonte daquele dado, se ele é de um livro, artigo, dissertação ou etc. Ele deve estar no formato ABNT.",
      epsgD: "É a projeção do Shapefile, um número inteiro, por exemplo 4326.",
      fileInputD:
        "O arquivo que será inserido é um arquivo compactado ZIP que contém o Shapefile para ser enviado. Dentro deste arquivo ZIP deve conter todos os arquivos de um Shapefile, como o “.shp”, “.prj”, “.dbf” e etc.",
      ...
      startDate:
        "Data inicial do bounding box temporal da camada. É a data inicial do período que abrange os dados da camada. Por exemplo: a camada tem o período de 01-01-1900 à 31-12-1930. Logo a data inicial é 01-01-1900.",
      endDate:
        "Data final do bounding box temporal da camada. É a data final do período que abrange os dados da camada. Por exemplo: a camada tem o período de 01-01-1900 à 31-12-1930. Logo a data final é 31-12-1930.",
      ...
      startDateMask:
        "Indica qual é a máscara usada pela data inicial da camada.",
      ...
      mountLayer: {
        ...
        lblAttr: "Atributos",
        lblAttrD:
          "Adicione os atributos da nova camada. NÃO pode: começar com números, ter acentuação, caracteres especiais, espaços em brancos e ser nome reservado.",
        boxAttr: {
  ...
  login: {
    ...
    btnText: "Entrar",
    terms:
      "Se você fizer login via rede social, estará automaticamente concordando com os termos do projeto.",
    ...
    msg: {
      ...
      err409:
        "Você ainda <strong>não confirmou seu e-mail</strong>, acesse sua caixa de e-mail e confirme-o seguindo instruções!",
    },
  },
  home: {
    title1: "O que é?",
  ...
  about: {
    ...
    desc1:
      "Luis Ferla é professor de história contemporânea da UNIFESP. Nessa Universidade, coordena o grupo de pesquisas Hímaco (História, mapas e computadores) e o lab.hum (Laboratório de Humanidades Digitais). Juntamente com Karla Donato Fook, é um dos coordenadores do projeto. ",
    name2: "Karine Reis Ferreira",
    desc2:
      "Karine Reis Ferreira é doutora em Computação Aplicada pelo INPE, onde trabalha com pesquisa em GeoInformática e desenvolvimento de sistemas de informações geográficas. É docente do curso de pós-graduação em Computação Aplicada (CAP) do INPE e sua principal linha de pesquisa é representação, processamento e análise de grandes volumes de dados espaço-temporais. Ela foi coordenadora do projeto Pauliceia de 2016 até 2019.",
    name3: "Andrew Graham Britt",
    desc3:
      "Andrew G. Britt é historiador da América Latina com foco na história do Brasil. Atualmente é um Postdoctoral Fellow na Northwestern University em Evanston, IL. É um dos integrantes do projeto.",
    name4: "Ana Maria Alves Barbour",
    desc4:
      "Ana Maria Barbour é jornalista, historiadora e mestranda em História pela Unifesp. É colaboradora do projeto Pauliceia 2.0.",
    name5: "Cíntia Rodrigues de Almeida",
    desc5:
      "Cintia Rodrigues de Almeida é graduanda em História na UNIFESP e bolsista de Iniciação Científica pela FAPESP.",
    name6: "Carlos Alberto Noronha",
    desc6:
      "Carlos Noronha, aluno de IC no INPE e desenvolvedor de software com ênfase em sistemas web.",
    name7: "Cristiane Regina Myiasaka",
    desc7:
      "Cristiane Miyasaka é doutora em História (IFCH/Unicamp). É integrante do Hímaco (Unifesp). Coordena a equipe responsável pelo banco de dados de endereços históricos.",
    name8: "Daniela Leal Musa",
    desc8:
      "Daniela Musa é docente da área de Ciência da Computação no Instituto de Ciência e Tecnologia da Unifesp. Sua área de pesquisa é Banco de Dados, Web Semântica e dados espaço-temporal.",
    name9: "Ester Dantas Reis Nunes",
    desc9:
      "Ester Reis, estudante de História na EFLCH/UNIFESP, bolsista FAPESP sobre o uso de Sistemas de Informações Geográficas (SIG) em investigações históricas.",
    name10: "Denis Taveira de Lima",
    desc10:
      "Denis Taveira é estudante de Engenharia da Computação na UNIFESP e bolsista de Iniciação Cientifica no INPE pela FAPESP. É um dos responsáveis pelo desenvolvimento da plataforma web da Pauliceia 2.0.",
    name11: "Fernando Atique",
    desc11:
      "Fernando Atique é Arquiteto e Urbanista. Professor de História, Espaço e Patrimônio Edificado na EFLCH/UNIFESP. Colaborou com o levantamento de dados históricos e espaciais.",
    name12: "Eduardo de Souza Goiabeira",
    desc12:
      "Eduardo Goiabeira é graduado em História pela EFLCH/UNIFESP. Ele contribuiu para a criação do banco de dados de numeração do projeto.",
    name13: "Jeffrey Lesser",
    desc13:
      "Jeffrey Lesser é um históriador do Brasil e diretor  do Instituto Halle de Pesquisa Global da Universidade Emory, e parceiro internacional do Projeto apoiado pela FAPESP.",
    name14: "Gabriel Sansigolo",
    desc14:
      "Gabriel Sansigolo é mestrando em Computação Aplicada, Tecnólogo em Análise e Desenvolvimento de Sistemas e Técnico em Informática Web.",
    name15: "Luanna M. do Nascimento",
    desc15:
      "Luanna Nascimento é graduanda em História na UNIFESP e bolsista de Iniciação Científica pela FAPESP no Projeto Pauliceia 2.0.",
    name16: "Gilberto Ribeiro de Queiroz",
    desc16:
      "Gilberto é Professor Associado em Geoinformática no INPE, possui doutorado em Computação Aplicada. No projeto Pauliceia 2.0 está envolvido no projeto conceitual da plataforma computacional.",
    name17: "Monaliza Caetano",
    desc17:
      "Monaliza Caetano é historiadora, graduada através da Universidade Federal de São Paulo. É uma das bolsistas do Projeto aprovado na FAPESP.",
    name18: "Nandamudi Vijaykumar",
    desc18:
      "N. L. Vijaykumar é Tecnólogo de Computação, Mestre em Computação Aplicada e Doutor em Informática. Participou do Programa de PósDoutorado na University College Cork (Irlanda) na área de Modelagem Computacional de Impacto de Ventos e Ondas na área Costeira da Irlanda. Participa do projeto Pauliceia e tem interesse nas áreas de Engenharia de Software, em particular, em validação e verificação de software, aplicações de Inteligência Artificial em Cidades Inteligentes, e validação e verificação de contratos em Blockchain.",
    name19: "Orlando Guarnier Farias",
    desc19:
      "Orlando Guarnier é estudante de história da EFLCH/UNIFESP e membro do grupo Hímaco.",
    name20: "Rodrigo Mariano",
    desc20:
      "Rodrigo Mariano é Analista e Desenvolvedor de Sistemas, e mestre em Computação Aplicada pelo INPE na área de Geocomputação. Sua principal atividade no projeto é no desenvolvimento do serviço de gerenciamento dos dados da plataforma, desde o controle de usuários, camadas, manipulação dos dados espaço-temporais, até o controle das notificações e denúncias. Ele é o atual responsável pela manutenção da plataforma.",
    name21: "Priscila Machado Meireles",
    desc21:
      "Priscila Meireles é Arquiteta e Urbanista, Especialista em Design Gráfico. Como colaboradora do projeto desenvolveu os elementos de Identidade Visual, que contemplam a criação da marca “Pauliceia 2.0”, além do web design: site e plataforma.",
    name22: "Thomas Rogers",
    desc22:
      "Thomas Rogers é historiador, professor de história na Universidade Emory. Ele co-coordenou a bolsa SPRINT, de FAPESP, para Emory e UNIFESP.",
    name23: "Vitória Martins Fontes da Silva",
    desc23:
      "Vitória Martins Fontes é graduada em história pela UNIFESP. Participa das atividades do grupo Hímaco e desde 2018 compõe a equipe desenvolvedora do Pauliceia 2.0. No projeto, fez parte do grupo responsável pelo banco de dados da numeração da plataforma e atualmente produz material de apoio para utilização do Pauliceia e integra o grupo que implementa a região do Bom Retiro.",
    name24: "Wania Mazzarello",
    desc24:
      "Wania possui licenciatura em história. Atua como pesquisadora, consultora e professora. Possui interesse de pesquisa em história urbana, identidade, memória e tecnologia. No Projeto, atua na equipe que viabiliza a introdução da área do Pari no escopo da plataforma.",
    name25: "Gabriel dos Reis",
    desc25:
      "Gabriel dos Reis é graduando em Análise e Desenvolvimento de Sistemas pelo Instituto Federal da Bahia. Tendo ingressado no Projeto em uma experiência no ano 2020, busca auxiliar o Pauliceia nos aspectos que puder, sejam eles computacionais ou não.",
    name26: "Karla Donato Fook - coordenadora",
    desc26:
      "Karla Donato Fook é professora do Instituto Tecnológico de Aeronáutica (ITA). Suas áreas de interesse na Pesquisa incluem Geoinformação e Engenharia de Software. No Projeto Pauliceia 2.0 ela está envolvida com o gerenciamento da plataforma computacional.",
    name27: "Aracele Torres",
    desc27:
      "Aracele Torres é doutora em História pela USP, atuando na área de História da Ciência e da Tecnologia, com foco em ciências e tecnologias abertas. É membro do Hímaco (História, Mapas e Computadores) e do lab.hum (Laboratório de Humanidades Digitais) da UNIFESP/Guarulhos. Faz contribuições técnicas para o projeto, além de contribuir como pesquisadora.",
    name28: "Raphael Augusto de Oliveira Silva",
    desc28:
      "Raphael Augusto de Oliveira Silva é graduado em História pela UNIFESP. Atualmente é aluno de Engenharia da Computação da UNIVESP. Suas contribuições são tanto para a manutenção do Portal como também para o desenvolvimento das pesquisas.",
    ...
    name30: "Marina Gomes",
    desc30:
      "Marina Pereira Gomes é graduada em História pela UNIFESP. Foi bolsista de Iniciação Científica pela FAPESP e atuou na equipe responsável pela expansão espacial da área do geolocalizador da plataforma Pauliceia 2.0. ",
  ...
  register: {
    ...
    msg: {
      ...
      success:
        "O teu cadastro está quase pronto. Basta acessar o teu e-mail e seguir as instruções.",
      emptyField: "ERRO: complete todos os campos!",
      err500: "Erro no servidor interno - entre em contato com o administrador",
      err409:
        "<strong>E-mail</strong> ou <strong>nome de usuário</strong> já existe em nosso sistema.",
    },
  },
  validEmail: {
    msgSuccess:
      "Olá, seu e-mail foi validado com <strong>sucesso</strong>! Agora é só realizar o <i>login</i> para acessar o sistema.",
  ...
  map: {
    ...
    addLayer: {
      ...
      input:
        "Pesquise por tema, camada, autor ou data de criação (exemplo: 31/12/2001):",
      close: "Fechar",
      box: {
        lbTitle: "TÍTULO",
        lbAuthors: "AUTORES",
      ...
      msg: {
        ...
        errMsg:
          "Serviço indisponível, tente mais tarde ou comunique nosso suporte!",
      },
    },
    viewInfo: {
