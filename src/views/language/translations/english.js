...
export default {
  ...
  dashboard: {
    ...
    notification: {
      ...
      ofYourMessageGlobalNotification:
        "of your message on your global notification",
    ...
    newLayer: {
      ...
      keywordsD:
        "Keyword is a tag/label related to the layer, which indicates what type it belongs, such as streets, addresses, crimes and so on.",
      collaboratorsD:
        "Collaborators are the people who can add, edit or remove the vectors from the layer. Vectors are the geometries from the layer, such as a point, line or polygon. Only the layer creator can edit this field for security!",
      descriptionD: "Description is a description/information about the layer.",
      referenceD:
        "Reference is the source of that data, whether it is from a book, article, dissertation or so on. It should be in the ABNT format.",
      epsgD:
        "It is the projection of the Shapefile, a integer number, for example 4326",
      fileInputD:
        "The file that will be inserted is a ZIP compressed file that contains the Shapefile to be sent. Inside this ZIP file should contains all the files of a Shapefile, such as “.shp“, “.prj“, “.dbf“ and so on.",
      ...
      startDate:
        "Start date of the temporal bounding box of the layer. This is the start date of the period that covers the layer data. For example: the layer has the period from 01-01-1900 to 31-12-1930. Hence the start date is 01-01-1900.",
      endDate:
        "End date of the temporal bounding box of the layer. This is the end date of the period that covers the layer data. For example: the layer has the period from 01-01-1900 to 31-12-1930. Therefore the end date is 31-12-1930.",
      startDateColumn:
        "It indicates which column contains the start date of the layer.",
      endDateColumn:
        "It indicates which column contains the end date of the layer.",
      startDateMask:
        "It indicates which mask is used by the start date of the layer.",
      endDateMask:
        "It indicates which mask is used by the end date of the layer.",
      mountLayer: {
        btnRadio: {
          import: "IMPORT FILE",
        ...
        lblAttr: "Attributes",
        lblAttrD:
          "Add the attributes of the new layer. It can NOT: start with numbers, have accents, special characters, whitespaces and be reserved name.",
        boxAttr: {
  ...
  login: {
    ...
    msg: {
      ...
      err409:
        "You have <strong>not yet confirmed your email</strong>, access your email box and confirm it by following instructions!",
    },
  },
  home: {
    title1: "What is it?",
    ...
    example: "Example",
    column1:
      "Pauliceia 2.0 is a platform to make the collaborative mapping of history of the city of São Paulo for the period 1870 to 1940.",
    ...
    column3:
      "A beta is currently available for testing. The final version is scheduled for January 2022.",
  },
  contact: {
  ...
  about: {
    ...
    text2:
      "The project was one of the four contemplated by the eScience 2016 call of FAPESP (Foundation for Research Support of the State of São Paulo), which stimulates collaboration between areas of computer science and any other area of knowledge.",
    ...
    desc1:
      "Luis Ferla is professor of contemporary history at Unifesp. In this University, he coordinates the research group Himaco (History, maps and computers) and lab.hum (Laboratory of Digital Humanities). Together with Karla Donato Fook, he is one of the coordinators of the project",
    name2: "Karine Reis Ferreira ",
    desc2:
      "Karine Reis is PhD in Applied Computer by the National Institute For Space Research (INPE), she works on researching in geoinformatics and on geographic information systems development. She is professor of the Applied Computer Graduate Course at INPE and her main research topic is representation, processing and analysis of big spatiotemporal data and temporal GIS development. She was the coordinator of the Pauliceia project from 2016 to 2019.",
    name3: "Andrew Graham Britt",
    desc3:
      "Andrew G. Britt is a historian of Latin America (Brazil) and a digital scholarship developer. He is currently a Postdoctoral Fellow at Northwestern University and a member of the project team.",
    name4: "Ana Maria Alves Barbour",
    desc4:
      "Ana Maria Barbour is a journalist, historian and currently pursuing her master's degree in History at Unifesp. She is a collaborator in the Pauliceia 2.0 project.",
    ...
    desc8:
      "Daniela Musa is professor at the Institute of Science and Tecnology of the Federal University of São Paulo (UNIFESP), Brazil. Her research interests include Databases, Semantic Web and spatial-temporal data.",
    name9: "Ester Dantas Reis Nunes",
    desc9:
      "Ester Reis, is a history student at EFLCH/UNIFESP, FAPESP scholarship about the use of the Geographic Information System (GIS) in historical research.",
    name10: "Denis Taveira de Lima",
    desc10:
      "Denis Taveira is a student of Computer Engineering at UNIFESP and a fellowship of Scientific Initiation at INPE by FAPESP. He is one of the responsible to development of the web platform of Pauliceia 2.0.",
    name11: "Fernando Atique",
    desc11:
      "Fernando Atique is Architect and Town Planner. Professor of History, Space and Built Heritage at EFLCH/UNIFESP. He contributed with spatial and historical data with the project.",
    name12: "Eduardo de Souza Goiabeira",
    desc12:
      "Eduardo Goiabeira holds a degree in History from EFLCH/UNIFESP. He contributed to the creation of the project numbering database.",
    name13: "Jeffrey Lesser",
    desc13:
      "Jeffrey Lesser is a historian of Brazil and the Director of the Halle Institute for Global Research at Emory University, the international partner for the Project supported by FAPESP.",
    name14: "Gabriel Sansigolo",
    desc14:
      "Gabriel Sansigolo is taking master's degree in Applied Computation by the National Institute of Space Research. Technologist in Analysis and Development of Systems. Has IT Technician for Internet.",
    name15: "Luanna M. do Nascimento",
    desc15:
      "Luanna Nascimento is majoring History at UNIFESP and has a research scholarship given by FAPESP to the Project Pauliceia 2.0.",
    name16: "Gilberto Ribeiro de Queiroz",
    desc16:
      "Gilberto is an Associate Professor of Geoinformatics at INPE with a PhD in Applied Computing. In the Pauliceia 2.0 project he is involved with the conceptual design of the computational platform.",
    name17: "Monaliza Caetano",
    desc17:
      "Monaliza Caetano, is a historian, graduated in Federal University of São Paulo. She is one of the scholarship of the Project supported by FAPESP.",
    name18: "Nandamudi Vijaykumar",
    desc18:
      "N. L. Vijaykumar (Vijay) has experience in Software Engineering, Model Based Testing and Performance Evaluation. He is retired and Voluntary Collaborator at the Laboratory of Computing and Applied Mathematics (LAC) of the National Institute for Space Research (INPE).",
    ...
    desc20:
      "Rodrigo Mariano is Systems Analyst and Developer, and a master in Applied Computing by INPE in the area of Geocomputing. His main activity in the project is the development of the platform's data management service, since the user control, layers, spatio-temporal data manipulation, to the control of notifications and denunciations.",
    name21: "Priscila Machado Meireles",
    desc21:
      'Priscila Meireles is Architect and Urbanist, Specialist in Graphic Design. As a collaborator of the project she developed the Visual Identity elements, which include the creation of the "Pauliceia 2.0" brand, as well as web design: website and platform.',
    name22: "Thomas Rogers",
    desc22:
      "Thomas Rogers is Associate Professor of History at Emory University. He was co-coordinator of the FAPESP SPRINT grant that connected Emory to UNIFESP for Pauliceia 2.0.",
    name23: "Vitória Martins Fontes da Silva",
    desc23:
      "Vitória Martins Fontes has a degree in history from UNIFESP. She participates in the activities of the Hímaco group and since 2018 she has been part of the Pauliceia 2.0 development team. In the project, she was part of the group responsible for the database of the platform numbering and currently produces support material for the use of Pauliceia and is part of the group that implements the Bom Retiro region.",
    name24: "Wania Mazzarello",
    desc24:
      "Wania has a degree in history. She acts as a researcher, consultant and teacher. Has a research interest in urban history, identity, memory and technology. In the Project, he acts in the team that makes possible the introduction of the Pari area in the scope of the platform.",
    name25: "Gabriel dos Reis",
    desc25:
      "Gabriel dos Reis is majoring in Analysis and Systems Development at the Federal Institute of Bahia. Having joined the Project in an experiment in the year 2020, he seeks to assist Pauliceia in the aspects he can, whether they are computational or not.",
    name26: "Karla Donato Fook - coordinator",
    desc26:
      "Karla Donato Fook is professor at Aeronautics Institute of Technology (ITA). Her research interests include Geoinformatics and Software Engineering. In the Pauliceia 2.0 project she is involved with the management of the computational platform.",
    name27: "Aracele Torres",
    desc27:
      "Aracele Torres holds a PhD in History from USP (University of Sao Paulo), working in the area of History of Science and Technology, focusing on open sciences and technologies. She is a member of Hímaco (History, Maps and Computers) and lab.hum (Laboratory of Digital Humanities) at UNIFESP/Guarulhos. She makes technical contributions to the project, in addition to contributing as a researcher.",
    name28: "Raphael Augusto de Oliveira Silva",
    desc28:
      "Raphael Augusto de Oliveira Silva has a degree in History from UNIFESP. He is currently a Computer Engineering student at UNIVESP. Your contributions are both for the maintenance of the Portal as well as for the development of research.",
    ...
    name30: "Marina Gomes",
    desc30:
      "Marina Pereira Gomes has a degree in History from UNIFESP. She received a Scientific Initiation scholarship from FAPESP and worked on the team responsible for the spatial expansion of the geolocator area of ​​the Pauliceia 2.0 platform.",
  ...
  register: {
    ...
    msg: {
      registerBtnHover:
        "You must accept the Use Terms in order to register yourself!",
      success:
        "Your registration is almost ready. Just access your email and follow the instructions.",
  ...
  validEmail: {
    msgSuccess:
      "Hello, your email was <strong>successfully</strong> validated! Now just <i>log in</i> to access the system.",
  ...
  map: {
    ...
    addLayer: {
      ...
      input:
        "Search by theme, layer, author or creation date (example: 31/12/2001):",
      close: "Close",
      box: {
        lbTitle: "TITLE",
        lbAuthors: "AUTHORS",
