      ...
      <header class="row row-style justify-content-md-center">
        <div class="col-sm-4 column-style">
          <div class="card card-style">
            <div class="card-body">
              <br />
              <h5 class="card-title">{{ $t("about.title1") }}</h5>
              <br />
              <div
                class="card-text"
                itemprop="about"
        ...
        <div class="col-sm-4 column-style">
          <div class="card card-style">
            <div class="card-body">
              <br />
              <h5 class="card-title">{{ $t("about.title2") }}</h5>
              <br />
        ...
        <div class="col-sm-4 column-style">
          <div class="card card-style">
            <div class="card-body">
              <br />
              <h5 class="card-title">{{ $t("about.title3") }}</h5>
              <br />
    ...
    <div class="container2">
      <div class="container">
        <div class="row justify-content-md-center">
          <div class="col-sm-12 column-style">
            <h5 class="title2">{{ $t("about.title7") }}</h5>
            <br />
          </div>
        </div>
        {{/**/}}
        <div class="row justify-content-md-center row-style">
          <div
            class="col-sm-4 column-style text-end"
          ...
          <div class="col-sm-2 column-style text-end">
        ...
        <div class="row justify-content-md-center row-style">
          <div
            ...
            itemtype="https://schema.org/Person"
          >
            <h5 class="title2" itemprop="name">Daniel Cordeiro</h5>
            {{ $t("about.desc31") }}
          </div>
          <div class="col-sm-2 column-style text-end">
            <img class="picture" src="@/views/assets/images/perfil/31.png" />
          </div>
        ...
        <div class="row justify-content-md-center row-style">
          <div
            ...
            itemtype="https://schema.org/Person"
          >
            <h5 class="title2" itemprop="name">Marina Gomes</h5>
            {{ $t("about.desc30") }}
          </div>
          <div class="col-sm-2 column-style text-end">
            <img class="picture" src="@/views/assets/images/perfil/30.png" />
          </div>
        ...
        <div class="row justify-content-md-center row-style">
          ...
          <div
            ...
            itemtype="https://schema.org/Person"
          >
            <h5 class="title2" itemprop="name">
              Raphael Augusto de Oliveira Silva
            </h5>
            {{ $t("about.desc28") }}
          </div>
        </div>
        ...
        <div class="row justify-content-md-center row-style">
          <div
            ...
            itemtype="https://schema.org/Person"
          >
            <h5 class="title2" itemprop="name">Renata Baesso</h5>
            {{ $t("about.desc29") }}
          </div>
          <div class="col-sm-2 column-style text-end">
            <img class="picture" src="@/views/assets/images/perfil/29.png" />
          </div>
        ...
        <div class="row justify-content-md-center row-style">
          ...
          <div
            ...
            itemtype="https://schema.org/Person"
          >
            <h5 class="title2" itemprop="name"></h5>
            <!-- {{ $t('about.desc20') }} -->
          </div>
        </div>
      </div>
        ...
        <div class="row justify-content-md-center">
          <div class="col-sm">
            ...
            <img
              class="picture"
              style="left: 30px"
              src="@/views/assets/images/logos/inpe_transparente.png"
            />
          </div>
          <div class="col-sm">
            <br />
            <img
              class="picture2"
              src="@/views/assets/images/logos/unifesp_verde_fundo_transparente.png"
            />
          </div>
          <div class="col-sm">
            <br />
            <img
              class="picture2"
              src="@/views/assets/images/logos/logo_himaco_fundo_transparente.png"
            />
          </div>
          <div class="col-sm">
            <br />
            <img
              class="picture2"
              src="@/views/assets/images/logos/labhum_2018-crop-u6539.jpg"
            />
          </div>
          ...
          <div class="col-sm">
            ...
            <img
              class="picture2"
              style="left: 30px"
              src="@/views/assets/images/logos/logofapesp_transparente.png"
            />
          </div>
          <div class="col-sm">
            <br />
            <img
              class="picture"
              style="left: 30px"
              src="@/views/assets/images/logos/eu_vt_280.png"
            />
          </div>
          <div class="col-sm">
            {{ $t("about.title6") }}
            <img
              class="picture2"
              style="left: 30px"
              src="@/views/assets/images/logos/fapesp_fundo_transparente.png"
            />
          </div>
        </div>
      </header>
