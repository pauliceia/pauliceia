      ...
      <div class="card rounded stylecard">
        <div class="card-body">
          ...
          <form class="form-signin" @submit.prevent="loginSubmit">
            ...
            ><br />
            <div>
              <button type="submit" class="btn style-btn btn-lg btn-block">
                {{ $t("login.btnText") }}
              </button>
            </div>
            <div class="row">
              <div class="col-6 link-social">
                <md-list-item
                  class="btn btn-danger style-google"
  ...
  methods: {
    ...
    async loginSubmit() {
      try {
        ...
        let credentials = decodeURI(
          window.btoa(encodeURI(this.email + ":" + password)),
        );
