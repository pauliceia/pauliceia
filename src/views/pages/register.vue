      ...
      <div class="card rounded stylecard">
        <div class="card-body">
          ...
          <form class="form-signin" @submit.prevent="registerSubmit">
            <div class="row mb-3 g-3">
              ...
              <div class="col-md-12">
                ...
                <input
                  ...
                  v-model="user.email"
                  class="form-control form-control-lg"
                  :placeholder="$t('register.lbEmail')"
                  required
                />
              </div>
              <div class="col-md-6">
                ...
                <input
                  ...
                  class="form-control form-control-lg"
                  :placeholder="$t('register.lbUsername')"
                  required
                />
              </div>
              <div class="col-md-6">
                ...
                <input
                  ...
                  class="form-control form-control-lg"
                  :placeholder="$t('register.lbPassword')"
                  required
                />
              </div>
            </div>
            ...
            <div class="box-check">
              <el-checkbox
                :label="$t('register.lbCheckNotification')"
                v-model="user.receive_notification_by_email"
              ></el-checkbox>
              <br />
              <el-checkbox
    ...
    async registerSubmit() {
      ...
      try {
        if (
          ...
          this.$store.dispatch(
            "auth/setUser",
            infoUser.data.features[0].properties,
          );
          ...
          this._msgBox(
            "SUCESSO",
            "<strong>" +
              infoUser.data.features[0].properties.name +
              "</strong>, " +
              this.$t("register.msg.success"),
            "success",
          );
        ...
        else this._msgBox("ERROR", this.$t("register.msg.err409"), "error");
      }
    },
    _cleanForm() {
      let userClean = {
