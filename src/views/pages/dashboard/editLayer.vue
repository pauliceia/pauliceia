          ...
          <div class="card-body">
              ...
              <form>
                ...
                <div class="form-group">
                  ...
                  <v-select
                    ...
                    label="username"
                    id="userSelect"
                    :disabled="!isTheCurrentUserTheLayerCreator"
                  ></v-select>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                      <a href="#" class="btn btn-primary" @click="addRef()">{{
                ...
                <div class="form-group" v-show="chosenRef.length !== 0">
                  ...
                  <ol>
                    <li
                      v-for="(reference, index) in chosenRef"
                      v-bind:key="reference.reference_id"
                    >
            ...
            <div class="row">
              <div class="col align-self-end">
                ...
                <a href="#" class="btn btn-danger" @click="Delete()">{{
            ...
            <div class="card-text">
              <form>
                ...
                <div class="form-row">
                  <div class="col align-self-end">
                    <br />
                    <a href="#" class="btn btn-primary" @click="Upload2()">{{
                      $t("dashboard.newLayer.submit")
                    }}</a>
                  </div>
                </div>
...
export default {
  ...
  computed: {
    ...
    isTheCurrentUserTheLayerCreator() {
      ...
      for (const myLayer of this.myLayers) {
        if (myLayer.layer_id === this.layer_id) return true;
      }
  ...
  methods: {
    ...
    Upload2() {
      ...
      Api()
        .put("/api/temporal_columns", temporalColumns)
        .then(
          (response) => {
            ...
            (response) => {
              ...
              if (this.isTheCurrentUserTheLayerCreator) {
                this.chosenUsers.forEach((u) => {
                  // PUT cada usuario colaborar da layer
                  let user_layer = {
                    properties: {
              ...
              Api()
                .get("/api/feature_table/?f_table_name=" + this.tableName)
                .then(
                  (response) => {
                    ...
                    response.data.features.filter(
                      (e) => {
                        ...
                        Object.getOwnPropertyNames(e.properties).forEach(
                          (c) => {
                            if (
                              c !== "geom" &&
                              c !== "__ob__" &&
    ...
    addRef() {
      if (this.auxRef != null) {
        ...
        Api()
          .post("/api/reference/create", reference)
          .then(
            (response) => {
              let ref_id = response.data.reference_id;
              this.chosenRef.push({
                description: this.auxRef,
                reference_id: ref_id,
              });
      ...
      Api()
        ...
        .then((response) => {
          ...
          this.chosenRefID.forEach((id) => {
            Api()
              .get("/api/reference/?reference_id=" + id)
              .then((response) => {
                response.data.features.filter((e) => {
                  this.chosenRef.push({
                    description: e.properties.description,
                    reference_id: e.properties.reference_id,
                  });
                });
              });
          });
          ...
          Api()
            .get("/api/user_layer/?layer_id=" + id)
            .then((response) => {
              response.data.features.forEach((u) => {
                Api()
                  .get("/api/user/?user_id=" + u.properties.user_id)
                  .then((response) => {
          ...
          Api()
            ...
            .then((response) => {
              ...
              Api()
                .get(
                  "/api/temporal_columns/?f_table_name=" +
                    this.layer.f_table_name,
                )
                .then((response) => {
                  ...
                  this.endColumnsName =
                    p.end_date_column_name === "None" ||
                    p.end_date_column_name === ""
                      ? null
                      : p.end_date_column_name;
                  this.startColumnsName =
                    p.start_date_column_name === "None" ||
                    p.start_date_column_name === ""
                      ? null
                      : p.start_date_column_name;
                  ...
                  this.startDateMask =
                    p.start_date_mask_id === null
                      ? null
                      : this.dateMask.filter(
                          (m) => m.mask_id === p.start_date_mask_id,
                        )[0];
                  this.endDateMask =
                    p.end_date_mask_id === null
                      ? null
                      : this.dateMask.filter(
                          (m) => m.mask_id === p.end_date_mask_id,
                        )[0];
                });
            });
        });
