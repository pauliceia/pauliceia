      ...
      <div class="card styleCard">
        <div class="card-body">
          <h5 class="card-title" style="text-align: center">
            <h3>{{ $t("dashboard.profile.profile") }}</h3>
          </h5>
          <div class="card-text">
            <form>
              <div class="form-row">
                <div class="form-group col-md-4 text-center">
                  ...
                  <a
                    ...
                    "
                    @click="UploadPicture()"
                    >{{ $t("dashboard.profile.uploadNewPicture") }}</a
                  >
                </div>
                <div class="form-group col-md-7">
                  <div class="form-group">
                    ...
                    >&nbsp;
                    <p-popover-labels
                      :text="$t('dashboard.profile.usernameMessage')"
                    />
                    <input
                      class="form-control"
                      v-model="user.name"
                  ...
                  <div class="form-group">
                    ...
                    <p-popover-labels
                      :text="$t('dashboard.profile.emailMessage')"
                    />
                    <input
                      type="email"
                      v-model="user.email"
        ...
        .put("/api/user", {
          ...
          properties: {
            ...
            receive_notification_by_email:
              vm.user.receive_notification_by_email,
          },
        })
        .then(
          function (response) {
