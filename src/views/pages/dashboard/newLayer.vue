  ...
  <p-dash-layout :title="$t('dashboard.nav.layer')">
    <div class="row">
      ...
      <div class="col-sm-12" v-if="shapeCorrect === false">
        <div class="card">
          <div class="card-body">
            <h6 class="mb-0">{{ $t("dashboard.nav.newLayer") }}</h6>
            <br />
            ...
            <form class="row">
              ...
              <div class="card-left col-sm-6">
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <p-popover-labels
                      :text="$t('dashboard.newLayer.keywordsD')"
                    />
                    <button
                      @click="newKeyword()"
                ...
                <div class="form-group">
                  <label for="userSelect">{{
                    $t("dashboard.newLayer.collaborators")
                  }}</label
                  >&nbsp;
                  <p-popover-labels
                    :text="$t('dashboard.newLayer.collaboratorsD')"
                  />
                  <v-select
                    v-model="selectedCollaborators"
                    :options="users"
                    @blur="saveCollaborators()"
                    id="userSelect"
                    label="username"
                    track-by="username"
                    multiple
                ...
                <div class="form-group">
                  <label for="inputDescription">{{
                    $t("dashboard.newLayer.description")
                  }}</label
                  >&nbsp;
                  <p-popover-labels
                    :text="$t('dashboard.newLayer.descriptionD')"
                  />
                  <textarea
                    v-model="description"
                ...
                <div class="form-group">
                  <label for="inputReference">{{
                    $t("dashboard.newLayer.reference")
                  }}</label
                  >&nbsp;
                  <p-popover-labels
                    :text="$t('dashboard.newLayer.referenceD')"
                  />
                  <div class="form-row">
                ...
                <div
                  class="form-group"
                  v-show="selectedReferences.length !== 0"
                >
                  <label for="inputReference">{{
                    $t("dashboard.newLayer.addedReferences")
                  }}</label>
                  <ol>
                    <li
                    ...
                    >
                      ...
                      &nbsp;&nbsp;&nbsp;&nbsp;
                      <button
                        @click="removeReference(reference.reference_id)"
              ...
              <div class="card-right col-sm-6">
                ...
                <div class="box-layer-file" v-if="typeSubmit == 'file'">
                  ...
                  >&nbsp;
                  <p-popover-labels
                    :text="$t('dashboard.newLayer.fileInputD')"
                  />
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text">{{
                        $t("dashboard.newLayer.zipFile")
                      }}</span>
                    </div>
                ...
                <div class="box-layer-input" v-if="false">
                  <label
                    >{{ $t("dashboard.newLayer.mountLayer.lblAttr") }}:</label
                  >
                  <p-popover-labels
                    :text="$t('dashboard.newLayer.mountLayer.lblAttrD')"
                  />
                  <div class="box-attr">
                    <div class="row">
                      <div class="col-5">
                        <label>{{
                          $t(
                            "dashboard.newLayer.mountLayer.boxAttr.lblColumnName",
                          )
                        }}</label>
                      </div>
                      <div class="col-5">
                        <label>{{
                          $t(
                            "dashboard.newLayer.mountLayer.boxAttr.lblColumnType",
                          )
                        }}</label>
                      </div>
                      ...
                      >
                        <div class="col-5">
                          <input
                            ...
                            "
                            class="form-control"
                            v-model="attr.column_name"
                          />
                        </div>
                        <div class="col-5">
                          <el-select
                            style="width: 100%"
                            v-model="attr.column_type"
                          >
                            <el-option
                              :key="item.value"
                              :label="item.label"
                        ...
                        <div class="col-2">
                          ...
                          >
                            <p>
                              {{
                                $t(
                                  "dashboard.newLayer.mountLayer.boxAttr.msgAlertRemove",
                                )
                              }}
                            </p>
                            <div style="text-align: right; margin: 0">
                              <el-button
                                @click="attr.visibleRemove = false"
                                size="mini"
                                type="text"
                                >{{
                                  $t(
                                    "dashboard.newLayer.mountLayer.boxAttr.btnAlert.no",
                                  )
                                }}</el-button
                              >
                              <el-button
                                ...
                                >{{
                                  $t(
                                    "dashboard.newLayer.mountLayer.boxAttr.btnAlert.yes",
                                  )
                                }}</el-button
                              >
                            </div>
      ...
      <div class="col-sm-6">
        <div class="card" v-if="shapeCorrect">
          <div class="card-body">
            <h5 class="card-title">
              {{ $t("dashboard.newLayer.temporalColumns") }}
            </h5>
            <div class="card-text">
              <form>
                <div class="form-row">
                  <div class="form-group col-md-4">
                    <label for="start_date">{{
                      $t("dashboard.newLayer.lblStartDate")
                    }}</label
                    >&nbsp;
                    <p-popover-labels
                      :text="$t('dashboard.newLayer.startDate')"
                    />
                    <input
                      class="form-control"
                      id="start_date"
                  ...
                  <div class="form-group col-md-4">
                    <label for="userSelect">{{
                      $t("dashboard.newLayer.lblStartDateColumn")
                    }}</label
                    >&nbsp;
                    <p-popover-labels
                      :text="$t('dashboard.newLayer.startDateColumn')"
                    />
                    <v-select
                      :options="columnsName"
                      id="start_date_column_name"
                      label=""
                      track-by=""
                      v-model="startColumnsName"
                    ></v-select>
                  </div>

                  <div class="form-group col-md-4">
                    <label for="userSelect">{{
                      $t("dashboard.newLayer.lblStartDateMask")
                    }}</label
                    >&nbsp;
                    <p-popover-labels
                      :text="$t('dashboard.newLayer.startDateMask')"
                    />
                    <v-select
                      :options="allMasks"
                      id="start_date_mask"
                ...
                <div class="form-row">
                  <div class="form-group col-md-4">
                    <label for="end_date">{{
                      $t("dashboard.newLayer.lblEndDate")
                    }}</label
                    >&nbsp;
                    <p-popover-labels
                      :text="$t('dashboard.newLayer.endDate')"
                    />
                    <input
                      class="form-control"
                      id="end_date"
                  ...
                  <div class="form-group col-md-4">
                    <label for="userSelect">{{
                      $t("dashboard.newLayer.lblEndDateColumn")
                    }}</label
                    >&nbsp;
                    <p-popover-labels
                      :text="$t('dashboard.newLayer.endDateColumn')"
                    />
                    <v-select
                      :options="columnsName"
                      id="end_date_column_name"
                      label=""
                      track-by=""
                      v-model="endColumnsName"
                    ></v-select>
                  </div>

                  <div class="form-group col-md-4">
                    <label for="userSelect">{{
                      $t("dashboard.newLayer.lblEndDateMask")
                    }}</label
                    >&nbsp;
                    <p-popover-labels
                      :text="$t('dashboard.newLayer.endDateMask')"
                    />
                    <v-select
                      :options="allMasks"
                      id="end_date_mask"
                ...
                <div class="form-row">
                  <div class="col align-self-end">
                    <br />
                    <a @click="Upload2()" class="btn btn-primary" href="#">{{
                      $t("dashboard.newLayer.submit")
                    }}</a>
                  </div>
                </div>
...
export default {
  ...
  computed: {
    ...
    ...mapState({
      ...
      storedSelectedKeywords: (state) =>
        state.dashboardNewLayer.selectedKeywords,
      storedSelectedCollaborators: (state) =>
        state.dashboardNewLayer.selectedCollaborators,
      storedDescription: (state) => state.dashboardNewLayer.description,
      storedSelectedReferences: (state) =>
        state.dashboardNewLayer.selectedReferences,
  ...
  methods: {
    ...
    saveCollaborators() {
      //Salvar os dados no Store
      this.$store.dispatch(
        "dashboardNewLayer/setCollaborators",
    ...
    saveDescription() {
      //Salvar os dados no Store
      this.$store.dispatch(
        "dashboardNewLayer/setDescription",
        this.description,
      );
    },
    saveReferences() {
      //Salvar os dados no Store
      this.$store.dispatch(
        "dashboardNewLayer/setReferences",
    ...
    timeout_upload() {
      //Erro de estouro de tempo ao criar a nova camada
      this.finished = 0;
      ...
      setTimeout((_) => {
        if (this.finished === 0) {
          ...
          this.loading.close();
          this._msgError(
            "Timeout! Caso o erro persista entre em contato com os administradores da plataforma!",
          );
        }
      }, 20000);
    },
    Upload2() {
      // cadastrar a segunda parte da camada - temporal columns
      ...
      if (endDateObject.getUTCFullYear() > currentDate.getUTCFullYear()) {
        this._msgError(
          `O ano da data final da camada deve ser no máximo ${currentDate.getFullYear()}!`,
        );
        return;
      }
      ...
      let temporalColumns = {
        properties: {
          ...
          start_date_mask_id:
            this.startDateMask != null && "mask_id" in this.startDateMask
              ? this.startDateMask.mask_id
              : null,
          end_date_mask_id:
            this.endDateMask != null && "mask_id" in this.endDateMask
              ? this.endDateMask.mask_id
              : null,
        },
      ...
      Api()
        .post("/api/temporal_columns/create", temporalColumns)
        .then(
          (response) => {
            this.loading.close();
    ...
    Upload() {
      //Cadastrar a primeira parte da Camada
      this._openFullLoading();
    ...
    async upload_from_file() {
      if (!("size" in this.file)) {
      ...
      } else if (this.file.size > 104857600) {
        // 104857600 == 50mb
        ...
        try {
          ...
          Api()
            .post("/api/layer/create", layer)
            .then(
              (response) => {
                //Cadastrando nova Layer
                ...
                Api()
                  .post("/api/changeset/create", changeset)
                  .then(
                    (response) => {
                      Api()
                        .post(
                          "api/import/shp/?f_table_name=" +
                            this.fTableName +
                            "&file_name=" +
                            this.file.name +
                            "&changeset_id=" +
                        ...
                        .then(
                          (response) => {
                            Api()
                              .get(
                                "/api/feature_table/?f_table_name=" +
                                  this.fTableName,
                              )
                              .then(
                                (response) => {
              ...
              (cause) => {
                ...
                if (cause.response.status === 409)
                  this._msgError(
                    "Já existe uma camada com esse nome, por favor, escolha outro!",
                  );
                else
                  this._msgError(
      ...
      try {
        if (this.optTpGeom == null) {
          ...
          let getNullAcenOrNumber = await this.optionsAttr.filter(
            (attr) =>
              attr.column_name === "" ||
              attr.column_type == null ||
              !/^[A-Za-z]{1}\w/.test(attr.column_name) ||
              /[^a-zA-Z0-9_]/.test(attr.column_name),
          );

          let getWordNative = await this.optionsAttr.filter((attr) =>
            ["id", "changeset_id", "version"].some(
              (attrName) => attrName === attr.column_name,
            ),
          );

          if (getNullAcenOrNumber.length > 0) {
            this._msgError(
              'Atributos Inválidos. Lembrando que cada atributo NÃO pode começar com "números" e possuir "acentuação"!',
            );
          } else if (getWordNative.length > 0) {
            this._msgError(
              "Atributos Inválidos. O nome do do atributo precisa ser diferente: id, changeset_id e version!",
            );
          } else {
            this.timeout_upload();
            ...
            this.selectedCollaborators.forEach(async (u) => {
              ...
              let responseUserLayer =
                await Dashboard.createUserLayer(user_layer);
            });

            //CREATE FEATUTE TABLE
            let properties = {};
            this.optionsAttr.map(async (attr) => {
              let attrName = attr.column_name
                .replace(/\s+/g, "_")
                .toLowerCase();
            ...
            let responseCreateFeatureTable =
              await Dashboard.createFeatureTable(featureTableInfo);

            let responseGetFeatureTable = await Dashboard.getFeatureTable(
              this.fTableName,
            );
    ...
    addReference() {
      if (this.reference_description != null) {
        ...
        Api()
          .post("/api/reference/create", new_reference)
          .then(
            (response) => {
            ...
            (cause) => {
              ...
              else this.$message.error(cause.toString());
            },
          );
      }
    },
    ...
    _msgError(msg) {
      if (this.loading != "" && this.loading != null) this.loading.close();
    ...
    _showErrorMessages(cause) {
      if ("data" in cause.response) this._msgError(cause.response.data);
      else this._msgError(cause.toString());

      if (cause.response.status >= 500)
        this._msgError(
          "Problem when creating a resource. Please, contact the administrator.",
        );
    },
    _openFullLoading() {
