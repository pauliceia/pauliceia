        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="card-text">
              <div
                class="row"
                v-for="layer in myLayers"
                v-bind:key="layer.layer_id"
              >
                ...
                <div class="col-sm-5">
                  <button
                    ...
                    @click="deleteLayer(layer.layer_id)"
                  >
                  ...
                  <button
                    ...
                    @click="editLayer(layer.layer_id)"
                  >
...
export default {
  ...
  methods: {
    ...
    updateLayers() {
      ...
      Api()
        .get("/api/user_layer/?user_id=" + this.user.user_id)
        .then((response) => {
          response.data.features.filter((e) => {
            Api()
              .get("/api/layer/?layer_id=" + e.properties.layer_id)
              .then((response2) => {
